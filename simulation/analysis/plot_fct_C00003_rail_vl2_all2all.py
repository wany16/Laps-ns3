...
# plt.yscale('symlog')
y_pticks_0 = [0, 2.5, 5, 7.5, 10]
y_pticks_0_str = ['0', '2.5', '5', '7.5', '10']

axs[0].set_yticks(y_pticks_0, y_pticks_0_str)
# axs[0].set_ylim([0, 4])  # 这里设置 y 轴的最小值和最大值

y_pticks_1 = [0, 100, 200, 300]
y_pticks_1_str = ['0', '100', '200', '300']
axs[1].set_yticks(y_pticks_1, y_pticks_1_str)
# axs[1].set_ylim([0, 150])  # 这里设置 y 轴的最小值和最大值
