...
# plt.yscale('symlog')
y_pticks_0 = [0, 2, 4, 6]
y_pticks_0_str = ['0', '2', '4', '6']

axs[0].set_yticks(y_pticks_0, y_pticks_0_str)
axs[0].set_ylim([0, 6])  # 这里设置 y 轴的最小值和最大值

y_pticks_1 = [0, 50, 100, 150, 200]
y_pticks_1_str = ['0', '50', '100', '150', '200']
axs[1].set_yticks(y_pticks_1, y_pticks_1_str)
axs[1].set_ylim([0, 220])  # 这里设置 y 轴的最小值和最大值
