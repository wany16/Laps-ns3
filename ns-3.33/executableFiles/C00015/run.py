...
oneLLMAPatternNameMap2 = {'One2all': 1,'All2one':1}
allLbsNameList = ['e2elaps', 'letflow', 'ecmp','plb','conweave','conga']
allLbsNameList1 = ['e2elaps']
loadratioListall=[
    '0.5', '0.55', '0.6', '0.65', '0.7', '0.75', '0.8', '0.85', '0.9', '0.95',
    '1.0'
]
...
def runTopoSimTest():
    ...
    for toponame in topoDirlist:
        ...
        for patternName, patternLoadRatioShift in oneLLMAPatternNameMap2.items():
            # 0.7
                enableLLMAFlowRateChange=False
                enablee2elapsPFC=True
                enableRecordLBOutInfo=True
                for lbsName in allLbsNameList1:
